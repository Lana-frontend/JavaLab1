...
public class Roller {
	...
	public Roller(int bevel, int power, String model, int volumes) {
		this(bevel, power, model, volumes, null,0,null,null);


	}

	public Roller(int bevel, int power, String model, int volumes, String name, double guarantee, String color,
			String address) {
		this.bevel = bevel;
		this.power = power;
		this.model = model;
	...
	public String toString() {
		return "Roller [bevel=" + bevel + ", power=" + power + ", model=" + model + ", volumes=" + volumes + ", name="
				+ name + ", guarantee=" + guarantee + ", color=" + color + ", address=" + address + "]";
	}
	...
	public static void main(String[] args) {
		Roller roller_bosch = new Roller(36, 550, "Bosch", 50, "Push", 12, "Green", "Lazarenka 40");
		Roller roller_ = new Roller();
		Roller roller_alko = new Roller(40, 750, "Al-Ko", 65, "Lock", 24, "Black", "Shevchenka 5");
		System.out.println("First one: " + "\n" + roller_bosch.toString());
		System.out.println("Second one: " + "\n" + roller_.toString());
		System.out.println("Third one: " + "\n" + roller_alko.toString());
